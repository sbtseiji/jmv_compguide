...
+ 練習用データファイル1（[intro_data01.omv](https://github.com/sbtseiji/jmv_compguide/tree/master/data/omv/intro_data01.omv)）
...
+ 練習用データファイル2（[intro_data01.csv](data/csv/intro_data01.csv)）

+ 練習用データファイル3（[intro_data01.xlsx](data/xlsx/intro_data01.xlsx)）
