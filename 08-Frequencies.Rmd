...
out <- jmvReadWrite::write_omv(data03, "data/omv/frequencies_data03.omv")
```
...
out <- jmvReadWrite::write_omv(fq.data03, "data/omv/frequencies_data03.omv")
...
out <- jmvReadWrite::write_omv(fq.data04, "data/omv/frequencies_data04.omv")
...
out <- jmvReadWrite::write_omv(data05, "data/omv/frequencies_data05.omv")
