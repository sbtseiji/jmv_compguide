...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c19 = "ref",
      peg$c20 = peg$literalExpectation("ref", false),
      peg$c21 = "eqref",
      peg$c22 = peg$literalExpectation("eqref", false),
      peg$c23 = "autoref",
      peg$c24 = peg$literalExpectation("autoref", false),
      peg$c25 = function(name, label) {
      ...
      peg$c30 = "url",
      peg$c31 = peg$literalExpectation("url", false),
      peg$c32 = function(x) {
          return { kind: "command.url", name: "url", url: x, location: location() };
        },
      peg$c33 = "href",
      peg$c34 = peg$literalExpectation("href", false),
      peg$c35 = function(arg, x, grp) {
          return { kind: "command.href", name: "href", url: x, content: grp.content, arg: arg || undefined, location: location() };
        },
      peg$c36 = "verb*",
      peg$c37 = peg$literalExpectation("verb*", false),
      peg$c38 = "verb",
      peg$c39 = peg$literalExpectation("verb", false),
      peg$c40 = function(name, e, end) {return end === e;},
      peg$c41 = function(name, e, x, end) {return end === e;},
      peg$c42 = function(name, e, x) {
          return { kind: "verb", name, escape: e, content: x, location: location() };
        },
      peg$c43 = "begin{verbatim}",
      peg$c44 = peg$literalExpectation("begin{verbatim}", false),
      peg$c45 = "end{verbatim}",
      peg$c46 = peg$literalExpectation("end{verbatim}", false),
      peg$c47 = function(x) {
          return { kind: "env.verbatim", name: "verbatim", content: x, location: location() };
        },
      peg$c48 = "begin{verbatim*}",
      peg$c49 = peg$literalExpectation("begin{verbatim*}", false),
      peg$c50 = "end{verbatim*}",
      peg$c51 = peg$literalExpectation("end{verbatim*}", false),
      peg$c52 = function(x) {
          return { kind: "env.verbatim", name: "verbatim*", content: x, location: location() };
        },
      peg$c53 = "begin{minted}",
      peg$c54 = peg$literalExpectation("begin{minted}", false),
      peg$c55 = "end{minted}",
      peg$c56 = peg$literalExpectation("end{minted}", false),
      peg$c57 = function(args, x) {
          return { kind: "env.minted", name: "minted", args: args, content: x, location: location() };
        },
      peg$c58 = "begin{lstlisting}",
      peg$c59 = peg$literalExpectation("begin{lstlisting}", false),
      peg$c60 = "end{lstlisting}",
      peg$c61 = peg$literalExpectation("end{lstlisting}", false),
      peg$c62 = function(arg, x) {
          return { kind: "env.lstlisting", name: "lstlisting", arg: arg, content: x, location: location() };
        },
      peg$c63 = "begin{comment}",
      peg$c64 = peg$literalExpectation("begin{comment}", false),
      peg$c65 = "end{comment}",
      peg$c66 = peg$literalExpectation("end{comment}", false),
      peg$c67 = function(x) {
      ...
      peg$c81 = "end",
      peg$c82 = peg$literalExpectation("end", false),
      peg$c83 = /^[^a-zA-Z]/,
      peg$c84 = peg$classExpectation([["a", "z"], ["A", "Z"]], true, false),
      peg$c85 = "[",
      ...
      peg$c93 = "def",
      peg$c94 = peg$literalExpectation("def", false),
      peg$c95 = function(token, numArgs, grArg) {
          return { kind: "command.def", token, args: numArgs.concat([grArg]), location: location() };
        },
      peg$c96 = function(c) {return c;},
      peg$c97 = function(x) {
          return { kind: "arg.group", content: x, location: location() };
        },
      peg$c98 = "left",
      peg$c99 = peg$literalExpectation("left", false),
      peg$c100 = "right",
      peg$c101 = peg$literalExpectation("right", false),
      peg$c102 = function(l, c) {return c;},
      peg$c103 = function(l, x, r) {
      ...
      peg$c115 = function(l, x, r) {
          return { kind: "math.math_delimiters", lcommand: l, rcommand: r, left: "\\{", right: "\\}", content: x, location: location() };
        },
      peg$c116 = "bigg",
      peg$c117 = peg$literalExpectation("bigg", false),
      peg$c118 = "Bigg",
      peg$c119 = peg$literalExpectation("Bigg", false),
      peg$c120 = "big",
      peg$c121 = peg$literalExpectation("big", false),
      peg$c122 = "Big",
      peg$c123 = peg$literalExpectation("Big", false),
      peg$c124 = /^[rlm]/,
      peg$c125 = peg$classExpectation(["r", "l", "m"], false, false),
      peg$c126 = function(body) {
          return { kind: "arg.optional", content: body, location: location() };
        },
      peg$c127 = function() { return {kind:"parbreak", location: location()}; },
      peg$c128 = ",",
      peg$c129 = peg$literalExpectation(",", false),
      peg$c130 = function(c) { return { kind: "text.string", content: c, location: location() }; },
      peg$c131 = function() {
          return { kind: "text.string", content: ",", location: location() };
        },
      peg$c132 = function(name, args, x) {return x;},
      peg$c133 = function(name, args, body, n) {return name === n;},
      peg$c134 = function(name, args, body, n) {
          return { kind: "env", name, args, content: body, location: location() };
        },
      peg$c135 = function(name, x) {return x;},
      peg$c136 = function(name, body, n) {return name === n;},
      peg$c137 = function(name, body, n) {
          return { kind: "env.math.align", name, args: [], content: body, location: location() };
        },
      peg$c138 = function(name, body, n) {
      ...
      peg$c140 = "text",
      peg$c141 = peg$literalExpectation("text", false),
      peg$c142 = function(arg) {
          return { kind: "command.text", arg: arg, location: location() };
        },
      peg$c143 = function(x) { return { kind: "comment", content: x, location: location() }; },
      peg$c144 = "begin",
      peg$c145 = peg$literalExpectation("begin", false),
      peg$c146 = "equation*",
      peg$c147 = peg$literalExpectation("equation*", false),
      peg$c148 = "equation",
      peg$c149 = peg$literalExpectation("equation", false),
      peg$c150 = "align*",
      peg$c151 = peg$literalExpectation("align*", false),
      peg$c152 = "align",
      peg$c153 = peg$literalExpectation("align", false),
      peg$c154 = "alignat*",
      peg$c155 = peg$literalExpectation("alignat*", false),
      peg$c156 = "alignat",
      peg$c157 = peg$literalExpectation("alignat", false),
      peg$c158 = "gather*",
      peg$c159 = peg$literalExpectation("gather*", false),
      peg$c160 = "gather",
      peg$c161 = peg$literalExpectation("gather", false),
      peg$c162 = "multline*",
      peg$c163 = peg$literalExpectation("multline*", false),
      peg$c164 = "multline",
      peg$c165 = peg$literalExpectation("multline", false),
      peg$c166 = "flalign*",
      peg$c167 = peg$literalExpectation("flalign*", false),
      peg$c168 = "flalign",
      peg$c169 = peg$literalExpectation("flalign", false),
      peg$c170 = "math",
      peg$c171 = peg$literalExpectation("math", false),
      peg$c172 = "displaymath",
      peg$c173 = peg$literalExpectation("displaymath", false),
      peg$c174 = "alignedat",
      peg$c175 = peg$literalExpectation("alignedat", false),
      peg$c176 = "aligned",
      peg$c177 = peg$literalExpectation("aligned", false),
      peg$c178 = "cases*",
      peg$c179 = peg$literalExpectation("cases*", false),
      peg$c180 = "cases",
      peg$c181 = peg$literalExpectation("cases", false),
      peg$c182 = "gathered",
      peg$c183 = peg$literalExpectation("gathered", false),
      peg$c184 = "split",
      peg$c185 = peg$literalExpectation("split", false),
      peg$c186 = "matrix",
      peg$c187 = peg$literalExpectation("matrix", false),
      peg$c188 = "bmatrix",
      peg$c189 = peg$literalExpectation("bmatrix", false),
      peg$c190 = "pmatrix",
      peg$c191 = peg$literalExpectation("pmatrix", false),
      peg$c192 = "vmatrix",
      peg$c193 = peg$literalExpectation("vmatrix", false),
      peg$c194 = "Bmatrix",
      peg$c195 = peg$literalExpectation("Bmatrix", false),
      peg$c196 = "Vmatrix",
      ...
      peg$c210 = "_",
      peg$c211 = peg$literalExpectation("_", false),
      peg$c212 = function() {
          return { kind: "subscript", arg: undefined, location: location() };
        },
      peg$c213 = "\0",
      peg$c214 = peg$literalExpectation("\0", false),
      peg$c215 = function() {
      ...
      peg$c226 = "document",
      peg$c227 = peg$literalExpectation("document", false),
      peg$c228 = function(c) {
          return c;
        },
      peg$c229 = "\n",
