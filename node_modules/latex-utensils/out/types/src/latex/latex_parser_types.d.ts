...
export declare type Node = TextString | Command | AmsMathTextCommand | DefCommand | UrlCommand | HrefCommand | LabelCommand | Environment | Group | OptionalArg | InlienMath | DisplayMath | MathCharacter | MatchingDelimiters | MathDelimiters | MathEnv | MathEnvAligned | Parbreak | Superscript | Subscript | AlignmentTab | CommandParameter | ActiveCharacter | Ignore | Verb | Verbatim | Minted | Lstlisting;
